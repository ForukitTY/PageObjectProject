...
class TestLoginFromMainPage:
    def test_guest_can_go_to_login_page(self, browser, getting_language):
    ...
    def test_guest_cant_see_product_in_basket_opened_from_main_page(self, browser, getting_language):
        link = f"http://selenium1py.pythonanywhere.com/{getting_language}/"
